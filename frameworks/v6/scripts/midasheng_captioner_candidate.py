...
def main() -> None:
    ...
    if args.action not in {"rollout", "grpo-update", "preflight"}:
        raise ValueError("V6 Captioner only supports rollout/GRPO/preflight")
    ...
    try:
        ...
        extra_metrics["captioner_batching"] = {
            ...
            "group_size_preserved": int(config["training"]["group_size"]),
